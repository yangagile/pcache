...
public interface DataOps {
    ...
    StsToken applyToken(ApplyStsToken applyStsToken, ClientCreationInfo clientCreationInfo);

    List<String> getPermissions(List<PcPermission> permissions);
}
